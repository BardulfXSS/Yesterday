...
mixin UnboundedRenderSliverPaddingMixin on RenderSliverPadding {
  ...
  void performLayout() {
    super.performLayout();
    final UnboundedSliverGeometry childGeometry = child.geometry;
  ...
  double layoutChildSequence({
    ...
    while (firstChild != null) {
      if (firstChild.geometry is UnboundedSliverGeometry) {
        UnboundedSliverGeometry childGeometry = firstChild.geometry;
