...
Serializer<LoginWithEmailPassword> _$loginWithEmailPasswordSerializer =
    new _$LoginWithEmailPasswordSerializer();
Serializer<LoginInitial<Object>> _$loginInitialSerializer =
    new _$LoginInitialSerializer();
Serializer<LoginLoading<Object>> _$loginLoadingSerializer =
    new _$LoginLoadingSerializer();
Serializer<LoginSuccess<Object>> _$loginSuccessSerializer =
    new _$LoginSuccessSerializer();
Serializer<LoginFailure<Object>> _$loginFailureSerializer =
    new _$LoginFailureSerializer();

class _$LoginWithEmailPasswordSerializer
    implements StructuredSerializer<LoginWithEmailPassword> {
  @override
  ...
  @override
  final String wireName = 'LoginWithEmailPassword';

  @override
  Iterable<Object> serialize(
      Serializers serializers, LoginWithEmailPassword object,
  ...
  @override
  LoginWithEmailPassword deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new LoginWithEmailPasswordBuilder();
...
class _$LoginInitialSerializer
    implements StructuredSerializer<LoginInitial<Object>> {
  @override
  final Iterable<Type> types = const [LoginInitial, _$LoginInitial];
  @override
  final String wireName = 'LoginInitial';

  @override
  Iterable<Object> serialize(
      Serializers serializers, LoginInitial<Object> object,
      {FullType specifiedType = FullType.unspecified}) {
    return <Object>[];
  }

  @override
  LoginInitial<Object> deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    return new LoginInitialBuilder().build();
  }
}

class _$LoginLoadingSerializer
    implements StructuredSerializer<LoginLoading<Object>> {
  @override
  final Iterable<Type> types = const [LoginLoading, _$LoginLoading];
  @override
  final String wireName = 'LoginLoading';

  @override
  Iterable<Object> serialize(
      Serializers serializers, LoginLoading<Object> object,
      {FullType specifiedType = FullType.unspecified}) {
    return <Object>[];
  }

  @override
  LoginLoading<Object> deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    return new LoginLoadingBuilder().build();
  }
}

class _$LoginSuccessSerializer
    implements StructuredSerializer<LoginSuccess<Object>> {
  @override
  final Iterable<Type> types = const [LoginSuccess, _$LoginSuccess];
  @override
  final String wireName = 'LoginSuccess';

  @override
  Iterable<Object> serialize(
      Serializers serializers, LoginSuccess<Object> object,
      {FullType specifiedType = FullType.unspecified}) {
  ...
  @override
  LoginSuccess<Object> deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final isUnderspecified =
        specifiedType.isUnspecified || specifiedType.parameters.isEmpty;
    ...
    final result = isUnderspecified
        ? new LoginSuccessBuilder<Object>()
        : serializers.newBuilder(specifiedType) as LoginSuccessBuilder;
...
class _$LoginFailureSerializer
    implements StructuredSerializer<LoginFailure<Object>> {
  @override
  final Iterable<Type> types = const [LoginFailure, _$LoginFailure];
  @override
  final String wireName = 'LoginFailure';

  @override
  Iterable<Object> serialize(
      Serializers serializers, LoginFailure<Object> object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object>[
      'error',
  ...
  @override
  LoginFailure<Object> deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new LoginFailureBuilder();
